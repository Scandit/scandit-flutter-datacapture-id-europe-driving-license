...
targets.insert(
    .target(
        name: "scandit_flutter_datacapture_id_europe_driving_license",
        dependencies: targetDeps,
        path: "Sources/scandit_flutter_datacapture_id_europe_driving_license"
    ),
    at: 0
)
...
let package = Package(
    ...
    products: [
        .library(
            name: "scandit-flutter-datacapture-id-europe-driving-license",
            targets: ["scandit_flutter_datacapture_id_europe_driving_license"]
        )
    ],
